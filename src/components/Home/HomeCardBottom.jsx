...
const HomeCardBottom = () => {
  return (
    <div className='w-full flex flex-wrap max-w-screen items-center justify-center gap-16 py-10 ' style={{backgroundImage: "linear-gradient(to bottom, #fff1eb 0%, #ace0f9 100%)"}}>
