...
const NavBar = () => {
  ...
  return (
    <div className="relative w-[100vw] border-b-2 bg-white">
      <div className="w-[95%] md:w-[95%] lg:w-full xl:w-full h-[10vh] flex justify-between items-center mx-auto px-0 md:px-0 lg:px-[10vw] xl:px-[10vw] ">
        <div className="flex gap-2 justify-center items-center">
          {!navActive && (
            <FaBars
              className="font-semibold text-xl block md:block lg:hidden xl:hidden"
          ...
          <ul className="flex justify-center items-center gap-2 md:gap-2 lg:gap-11 xl:gap-11 ">
            ...
            <li>
              <Link to="/become-a-tasker">
                <button className="font-semibold  text-sm md:text-sm lg:text-[17px] xl:text-[17px] border border-[#0d7a5f] hover:bg-[#0d7a5f] hover:text-white transition-all duration-300 text-[#0d7a5f] px-3 md:px-3 lg:px-8 xl:px-8 rounded-2xl py-1 md:py-1 lg:py-2 xl:py-2">
                  Become a Tasker
                </button>
              </Link>
            </li>
      ...
      {navActive && (
        <div className="w-full z-50 top-0 absolute h-[100vh] overflow-hidden block md:block lg:hidden xl:hidden ">
