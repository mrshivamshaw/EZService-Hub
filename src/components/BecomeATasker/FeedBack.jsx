...
const FeedBack = () => {
  return (
    <div className='w-[95%] md:w-[95%] lg:w-[80%] xl:w-[80%] mx-auto my-[10vh]'>
        <div className='flex mb-10 justify-start md:justify-start lg:justify-center xl:justify-center items-center gap-3'><div className='h-1 w-16 bg-[#309847] rounded-lg'></div><div className='w-3 h-3 bg-[#309847] rounded-full'></div><div className='h-1 w-16 bg-[#309847] rounded-lg'></div></div>
        ...
        <div className='flex  flex-col-reverse md:flex-col-reverse lg:flex-row xl:flex-row justify-center items-start'>
            <div className=' flex  flex-col justify-center items-start gap-6 pt-[6vh]'>
                <RiDoubleQuotesL className='text-6xl font-bold text-[#309847]'/>
