...
const LastSection = () => {
  return (
    <div className='w-full relative h-[40vh]'>
        <img src={footerImage} alt="footerImage" className='absolute bottom-1 z-0 w-full h-full hidden md:hidden lg:block xl:block'/>
        <div className='z-10 w-[95%] py-20 md:w-[95%] lg:w-[80%] relative xl:w-[80%] mx-auto flex flex-col justify-center items-start md:items-start lg:items-center xl:items-center gap-5'>
            <h1 className='text-4xl font-bold'>Ready to make money your way?</h1>
            <button className=' px-[5vw] text-center bg-[#40864f] py-2 rounded-3xl  text-white border-[1px] hover:scale-x-95 transition-all duration-200 hover:bg-white hover:border-[#40864f] hover:text-[#40864f] border-black text-xl font-bold'>Get Started</button>
