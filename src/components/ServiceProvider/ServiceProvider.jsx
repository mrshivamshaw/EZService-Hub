...
const ServiceProvider = () => {
  ...
  return (
    <div className="max-w-[100%] mt-12 h-auto mx-auto relative flex flex-col justify-center items-center gap-10 ">
    <div className="absolute right-0 -top-40 hidden md:hidden lg:block xl:block'"><img src={midShape} alt="mid shape" /></div>
        ...
        {serviceProviders.map((provider) => (
          <div key={provider.id} className="w-[97%] md:w-[330px] lg:w-[330px] xl:w-[330px] flex justify-center items-start gap-7 flex-col h-auto rounded-b-xl bg-[#eaf9ff58] shadow-md cursor-pointer">
            <div className="w-full h-auto">
              <img src={provider.img} alt="jh" className="w-[100%] md:w-[100%] lg:w-[330px] xl:w-[330px] h-[200px] " />
            </div>
            <div className="px-3">
